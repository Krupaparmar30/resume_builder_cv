            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                    ...
                    maxLines: 4,
                    decoration: personalNameBox(
                        labelText: 'Address', hintText: 'xyx', width: width)),
              ),
              SizedBox(
                height: height * 0.02,
              ),
              ...
              Padding(
                ...
                child: TextFormField(
                    ...
                    decoration: personalNameBox(
                        labelText: 'Drawing', hintText: 'fv', width: width)),
              ),
              SizedBox(
                height: height * 0.02,
              ),
              ...
              Center(
                child: GestureDetector(
                  onTap: () {
                    ...
                    personalEmail = txtPerEmail.text;
                    pdfList.add(
                        '${personalName} ${personalProfession} ${personalDob} ${personalAdd} ${personalNation} ${personalLan} ${personalHobby} ${personalContant} ${personalEmail}');
                  },
                  child: Container(
                    height: height * 0.09,
                    width: width * 0.4,
